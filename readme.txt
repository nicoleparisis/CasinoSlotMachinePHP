...
1. Navigate in browser to localhost/CS602_termProject_Tierney/create_tables.php this will create the database tables in phpMyadmin.

2. You do not need to insert data in the table to start playing the game because it will do this for you when you start.

3. Navigate to localhost/CS602_termProject_Tierney/index.php 
